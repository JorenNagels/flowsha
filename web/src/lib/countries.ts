// Country dial-code data for the feedback phone input. Alphabetical by name
// (UX convention for a searchable list). Flags are derived from the ISO-3166
// alpha-2 code as emoji at render time — no image assets and no network calls.

export type Country = { name: string; iso2: string; dial: string };

// Turn a two-letter ISO code into its flag emoji (regional-indicator letters).
...
export const DEFAULT_COUNTRY_ISO2 = 'GB';
